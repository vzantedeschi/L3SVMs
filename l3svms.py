...
def learning(train_x,train_y,test_x,test_y,verboseprint,CLUS,PCA_BOOL,LIN,LAND):
    ...
    verboseprint("iteration results: (accuracy,mean squared error,squared correlation coefficient), learning time")
